...
public class Convert
{
     ...
     * @return
     */
    public static List<Long> toList(String idStr, String split) {
        String[] splitArray = org.apache.commons.lang3.StringUtils.split(idStr, split);
        if (Objects.isNull(splitArray)) {
            return null;
        } else {
